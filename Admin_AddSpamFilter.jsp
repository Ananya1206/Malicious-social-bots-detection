...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Add Short URL's</span></h2>          
          <div class="clr"></div>          
		  <p>&nbsp;</p>
		  <form  name="s" action="Admin_AddSpamFilter1.jsp" method="post" enctype="multipart/form-data" onsubmit="return valid()">
                    <table width="410" border="0" align="center"  cellpadding="0" cellspacing="0" >
                      <tr>
                        <td  width="136" valign="middle" height="55" style="color: #2c83b0;"><div align="left" class="style5 style2 style4" style="margin-left:20px;"><b>Enter Short URL</b></div></td>
                        <td  width="274" valign="middle" height="55" style="color:#000000;"><label>
                          <input type="text" name="filtername" /> 
                          <a href="Admin_ViewFilterList.jsp" class="style6 style3"><strong>View Short URL's</strong></a> 
                        </label></td>
                      </tr>
                      <div >
                        <tr>
