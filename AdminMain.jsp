...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome Twitter Server Page</span></h2>          
          <div class="clr"></div>          
		  <p>&nbsp;</p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style1">
			...
			<li><strong><a href="Admin_AuthorizeUsers.jsp">View and Authorize Users</a></strong></li>
			<li><strong><a href="Admin_ViewFriendRequests.jsp">View Friend Request and Response</a></strong></li>
			<li><strong><a href="Admin_AddSpamFilter.jsp">View/Add Short URL</a></strong></li>
			<li><strong><a href="Admin_BlockSpammingAccounts.jsp">View all Spammer URL's</a></strong></li>
			...
			<li><strong><a href="Admin_ViewCommunity_Spam_NormalAccounts.jsp">View All URL Shortening Bots Users</a></strong></li>
			<li><strong><a href="Admin_ViewCommunitySpamBehaviour.jsp">View All URL Shortening based on Interactions</a></strong></li>
			<li><strong><a href="Admin_ViewCommunitySpamMetaData.jsp">View All URL Shortening based on Tweet Meta Data</a></strong></li>
			<li><strong><a href="Admin_ViewCommunity_Spam_NormalAcInChart.jsp">View Number of Shortening Bot Users</a></strong></li>
